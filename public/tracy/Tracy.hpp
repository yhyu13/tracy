...
#  define TracyAllocT( ptr, size, tag ) tracy::Profiler::MemAllocCallstack( ptr, size, TRACY_CALLSTACK, false, tag )
...
#  define TracySecureAllocT( ptr, size, tag ) tracy::Profiler::MemAllocCallstack( ptr, size, TRACY_CALLSTACK, true, tag )
...
#  define TracyAllocNT( ptr, size, name, tag ) tracy::Profiler::MemAllocCallstackNamed( ptr, size, TRACY_CALLSTACK, false, name, tag )
...
#  define TracySecureAllocNT( ptr, size, name, tag ) tracy::Profiler::MemAllocCallstackNamed( ptr, size, TRACY_CALLSTACK, true, name, tag )
...
#  define TracyAllocT( ptr, size, tag ) tracy::Profiler::MemAlloc( ptr, size, false, tag )
#  define TracyAlloc( ptr, size ) tracy::Profiler::MemAlloc( ptr, size, false )
#  define TracyFree( ptr ) tracy::Profiler::MemFree( ptr, false )
#  define TracySecureAllocT( ptr, size, tag ) tracy::Profiler::MemAlloc( ptr, size, true, tag )
...
#  define TracyAllocNT( ptr, size, name, tag ) tracy::Profiler::MemAllocNamed( ptr, size, false, name, tag )
...
#  define TracySecureAllocNT( ptr, size, name, tag ) tracy::Profiler::MemAllocNamed( ptr, size, true, name, tag )
...
#  define TracyAllocST( ptr, size, depth, tag ) tracy::Profiler::MemAllocCallstack( ptr, size, depth, false, tag )
...
#  define TracySecureAllocST( ptr, size, depth, tag ) tracy::Profiler::MemAllocCallstack( ptr, size, depth, true, tag )
...
#  define TracyAllocNST( ptr, size, depth, name, tag ) tracy::Profiler::MemAllocCallstackNamed( ptr, size, depth, false, name, tag )
...
#  define TracySecureAllocNST( ptr, size, depth, name, tag ) tracy::Profiler::MemAllocCallstackNamed( ptr, size, depth, true, name, tag )
